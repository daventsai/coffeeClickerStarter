...
function renderProducers(data) {
  ...
  const prodContainer = document.getElementById('producer_container');
...
bigCoffee.addEventListener('click', function(clickEvent){ clickCoffee(data);})
...
producerContainer.addEventListener('click',function(clickEvent){buyButtonClick(clickEvent,data);})
